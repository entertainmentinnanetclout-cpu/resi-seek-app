...
const pages = [
  ...
  ["/opportunities", "Student Opportunities, Bursaries & WIL | ResKonnect Opportunity", "Explore verified current bursaries, graduate programmes, WIL and student opportunities through the ResKonnect Opportunity Engine, with signed-in relevance guidance and official application routes.", "Verified Opportunities. Better Next Steps."],
  ...
  ["/ai", "ResKonnect AI | Grounded Student Guidance & Service Intelligence", "Use ResKonnect AI across Living, applications and opportunities with verified platform context and account-aware next-step guidance when signed in.", "ResKonnect AI: Grounded Guidance Across Your Student Journey"],
