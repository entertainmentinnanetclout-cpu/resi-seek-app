...
const ApplicationsHub = () => {
  ...
  if (!journey) {
    ...
    return <DashboardLayout>
      <SEO title="University & TVET Applications & Assistance | ResKonnect" description="Choose your study pathway, check APS and eligibility, prepare documents with ResKonnect and access hands-on application support through approved ResKonnect partners." />
      <div className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <MyApplicationCounts/><AssistedApplicationPartnerCard />
  ...
  if (category === "tvet") return <><MyApplicationCounts/><AssistedApplicationPartnerCard /><TvetApplicationsHub /></>;
  return <>
