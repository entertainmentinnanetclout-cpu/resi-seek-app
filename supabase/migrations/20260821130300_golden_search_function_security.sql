-- Lock internal Golden Search trigger functions against direct API/RPC execution.
...
-- The command centre is deliberately callable only by signed-in staff and also
-- performs an internal role check before returning aggregate SEO telemetry.
