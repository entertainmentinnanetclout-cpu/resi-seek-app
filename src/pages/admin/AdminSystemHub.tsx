  ...
  return (
    <AdminLayout>
      ...
      <div className="space-y-6">
        <div><h1 className="text-3xl font-bold">System Hub</h1><p className="text-muted-foreground">AdminOS command, automation, site updates, WIL, templates, backend health, system status & settings</p></div>
        <Tabs value={activeTab} onValueChange={(v) => setSearchParams({ tab: v })}>
          ...
          <TabsContent value="adminos"><AdminOSReleaseThreeContent /></TabsContent>
