...
import { BarChart3, Building2, Home, LogOut, LayoutDashboard, RefreshCw, TrendingUp, ShoppingCart, Film, Cpu, GraduationCap, Users, ClipboardCheck, Handshake, Bot } from "lucide-react";
...
const allNavItems=[
  ...
  {icon:Bot,label:"AdminOS Command",path:"/admin/system?tab=adminos",roles:GOD_MODE_ROLES},
