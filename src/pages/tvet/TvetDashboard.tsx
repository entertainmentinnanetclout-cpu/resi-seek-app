...
import TvetLayout from "@/components/tvet/TvetLayout";
...
export default function TvetDashboard() {
  ...
  return (
    <TvetLayout>
      <SEO title="TVET Lead Dashboard | ResKonnect" description="Manage TVET student applications and recruiter attribution" />
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          <div className="p-2 rounded-lg bg-primary/10 text-primary"><GraduationCap className="w-6 h-6" /></div>
          <div>
            <h1 className="text-3xl font-bold">TVET Lead Dashboard</h1>
