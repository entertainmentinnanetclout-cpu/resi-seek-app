  ...
  return (
    <Fragment>
      <header className="sticky top-0 z-[1000] isolate max-w-full overflow-visible border-b border-border bg-background/95 shadow-sm backdrop-blur-md">
        ...
        <div className="container mx-auto flex min-w-0 max-w-7xl items-center gap-3 overflow-visible px-3 py-2.5 sm:px-6 lg:px-8">
          ...
          <nav className="relative z-[1010] hidden items-center gap-1 overflow-visible md:flex">
            {PUBLIC_NAV.map((item) => {
              ...
              return (
                <div key={item.to} className="group relative z-[1020] overflow-visible">
                  ...
                  <div className="pointer-events-none invisible absolute left-0 top-[calc(100%-2px)] z-[1200] min-w-[285px] pt-2 opacity-0 transition-opacity duration-150 group-hover:pointer-events-auto group-hover:visible group-hover:opacity-100 group-focus-within:pointer-events-auto group-focus-within:visible group-focus-within:opacity-100">
                    <div className="rounded-xl border border-border bg-popover p-2 text-popover-foreground shadow-2xl ring-1 ring-black/5">
          ...
          <div className="ml-auto flex shrink-0 items-center gap-1 md:hidden">
            ...
            <Sheet open={open} onOpenChange={setOpen}>
              ...
              <SheetContent side="right" className="z-[1300] h-[100dvh] w-[min(92vw,22rem)] max-w-none overflow-hidden p-0">
