...
import PartnerDirectory from "@/pages/partners/PartnerDirectory";
...
export default function NotFound() {
  ...
  // The main router sends new partner subroutes through the wildcard. Keep
  // operational approval controls protected by server-side AAL2 and scoped roles.
  ...
  if (pathname === '/partners/directory' || pathname === '/partners/directory/') return <PartnerDirectory />;
