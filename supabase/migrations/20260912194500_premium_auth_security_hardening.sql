...
-- Twilio Verify is an independent security integration. The Edge Function can
-- provision the Verify service once, while credentials remain server-side.
