...
Deno.serve(async(req)=>{
  ...
  if(action==="start"){
    ...
    try{
      ...
      return json(req,{error:"verification_delivery_failed",message:"Could not send a WhatsApp verification code right now. Please try again later."},502);
    }
  }
  ...
  if(action==="verify"){
    ...
    try{
      ...
      return json(req,{error:"verification_check_failed",message:"Could not confirm the WhatsApp code right now. Please try again later."},502);
    }
  }
