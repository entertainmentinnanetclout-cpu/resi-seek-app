...
export default function AutomationAdvantageSection(){
  return <section className="relative overflow-hidden border-y bg-gradient-to-br from-emerald-500/[.05] via-background to-violet-500/[.05] py-12 md:py-18">
    ...
    <div className="container relative mx-auto grid gap-9 px-4 sm:px-6 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:px-8">
      <div>
        <div className="flex flex-wrap gap-2"><Badge className="rounded-full gap-1.5 px-3 py-1"><Sparkles className="h-3.5 w-3.5"/> Automation-first support</Badge><Badge variant="outline" className="rounded-full px-3 py-1">Dimpho + WhatsApp + Human handoff</Badge></div>
        <h2 className="mt-4 max-w-3xl text-3xl font-black tracking-[-.035em] md:text-5xl">Get help in seconds, not office hours.</h2>
        <p className="mt-4 max-w-2xl text-sm leading-7 text-muted-foreground md:text-base">ResKonnect now uses AI-assisted WhatsApp support to route accommodation, application and WIL enquiries immediately. Dimpho can guide routine steps, read current ResKonnect listing data and hand the full conversation to a human when judgement is required.</p>
